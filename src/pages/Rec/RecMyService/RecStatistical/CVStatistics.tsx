...
interface StatisticsData {
  leftChartData: { month: string; totalApplications: number; submitted: number; accepted: number; rejected: number }[]
...
const CVStatistics: React.FC = () => {
  ...
  const fetchData = async () => {
    ...
    switch (filterType) {
      case 'year':
        endpoint = `/recruiter/statistic/application_statistic_by_year?year=${year}`
        break
      case 'month':
        endpoint = `/recruiter/statistic/application_statistic_by_month?month=${month}&year=${year}`
        break
      case 'range':
        const [startDate, endDate] = dateRange
        endpoint = `/recruiter/statistic/application_statistic?startDate=${startDate}&endDate=${endDate}`
        break
      default:
        break
    }
