...
const StatisticsJobChart: React.FC = () => {
  ...
  const fetchStatistics = async () => {
    ...
    switch (filterType) {
      case 'year':
        endpoint = `/admin/statistic/application_statistic_by_year?year=${year}`
        break
      case 'month':
        endpoint = `/admin/statistic/application_statistic_by_month?month=${month}&year=${year}`
        break
      case 'range':
        const [startDate, endDate] = dateRange
        endpoint = `/admin/statistic/application_statistic?startDate=${startDate}&endDate=${endDate}`
        break
      default:
        break
    }
